<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Banner Listesi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=SITE?>">Anasayfa</a></li>
              <li class="breadcrumb-item active">Banner İşlemleri</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
					...
					for($i=0;$i<count($veriler);$i++)
					{
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            Açıklama: <?=stripslashes($veriler[$i]["aciklama"])?>
                        </td>
                          <td>
                      ...
                      <label class="custom-control-label" for="customSwitch3<?=$veriler[$i]["ID"]?>"></label>
                          ...
                          <a href="<?=SITE?>banner-sil/<?=$veriler[$i]["ID"]?>" class="btn btn-danger btn-sm silmeAlani">Sil</a>
                          </td>
                        </tr>
                        <?php
					}
