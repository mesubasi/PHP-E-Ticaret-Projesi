<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Kategori Listesi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
				...
				if($veriler!=false)
				{
					...
					for($i=0;$i<count($veriler);$i++)
					{
                        ...
                        <tr>
                          ...
                          <td>
                          <?php
                          if($veriler[$i]["tablo"]=="modul") //anakategori gizlenmemesi için
                          {
                            echo "AKTİF MODÜL!";
                          }
                          else
                      ...
                      <label class="custom-control-label" for="customSwitch3<?=$veriler[$i]["ID"]?>"></label>
                          ...
                          <?php
                          if($veriler[$i]["tablo"]=="modul") //anakategori silinmemesi için
                          {
                          ...
                          {
                            ?>
                            <a href="<?=SITE?>kategori-sil/<?=$veriler[$i]["ID"]?>" class="btn btn-danger btn-sm silmeAlani">Sil</a>
                            <?php
                          }
                          ?>
